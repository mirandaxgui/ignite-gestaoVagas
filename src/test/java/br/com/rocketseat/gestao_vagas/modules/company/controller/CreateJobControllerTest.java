package br.com.rocketseat.gestao_vagas.modules.company.controller;
...
public class CreateJobControllerTest {
  ...
  public void should_be_able_to_create_a_new_job() throws Exception {
    ...
    var createdJobDTO = CreateJobDTO.builder().benefits("BENETITS_TEST").description("DESCRIPTION_TEST").level("LEVEL_TEST").build();
